...
--VIEWS AND MATERILZED VIEWS

 Summary of Behavior After Insert
Feature	View	Materialized View
Reflects new rows?	✅ Immediately	❌ Not immediately
Manual refresh needed?	❌ No	✅ Optional (for fast updates)
Uses compute on query?	✅ Yes (every time)	❌ No (reads precomputed data)
